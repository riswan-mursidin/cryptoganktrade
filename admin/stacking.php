		...
		<form method="post" action="" class="container">
			<div class="row">
				...
				<div class="mb-3">
					...
					<input name="persen" required type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
				</div>
			</div>
			<div class="row mb-3">
				...
				<div class="col-6"><label class="form-label text-white">Market DOGE</label> <input name="val[]" required type="number" class="form-control mb-2" id="exampleInputEmail1" aria-describedby="emailHelp" /></div>
				<div class="col-6"><label class="form-label text-white">Market BTT</label> <input name="val[]" required type="number" class="form-control mb-2" id="exampleInputEmail1" aria-describedby="emailHelp" /></div>
				<div class="col-6"><label class="form-label text-white">Market TRON</label> <input name="val[]" required type="number" class="form-control mb-2" id="exampleInputEmail1" aria-describedby="emailHelp" /></div>
				<div class="col-6"><label class="form-label text-white">Market SHIBA</label> <input name="val[]" required type="number" class="form-control mb-2" id="exampleInputEmail1" aria-describedby="emailHelp" /></div>
			</div>
